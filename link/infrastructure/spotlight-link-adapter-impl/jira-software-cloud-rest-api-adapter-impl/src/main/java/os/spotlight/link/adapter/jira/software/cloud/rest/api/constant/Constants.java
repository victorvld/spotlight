...
public final class Constants {
    ...
    private static final String GET_ALL_BOARDS_SCHEMA_CLASSPATH = "schemas/jira/software/cloud/rest/api/get_all_boards_jira_api_response_schema.json";

    private static final String GET_ALL_GROUPS_SCHEMA_CLASSPATH = "schemas/jira/software/cloud/rest/api/get_all_groups_jira_api_response_schema.json";
